...
public class DailyReportTable extends JFrame {
  ...
  private void viewReport()
  {
    try
    {
	  ...
	  CallableStatement cs = dbconnection.prepareCall("{call getDailyLog()}");
    ...
    public DailyReportTable() {
        ...
        gradesLabel = new JLabel("Daily Report");
